...
public class jDModProveedor extends javax.swing.JDialog {
    ...
    public jDModProveedor(java.awt.Frame parent, boolean modal,String usu,String pass,int a,String quien) {
        super(parent, modal);
        initComponents();
    ...
    public jDModProveedor(java.awt.Frame parent, boolean modal,String host,String usu,String pass,String puerto,String database,int a,String quien) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Modificar Proveedor");
    ...
    private void jBAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAceptarActionPerformed
        ...
        if(!jTRUC.equals("")){
            if(!JTNombre.equals("")){
                db.actualizarRegistro("Proveedor","Nom_proveedor='"+JTNombre.getText()+"',Tel_proveedor='"+jTTelefono.getText()+"',Direc_proveedor='"+jTDireccion.getText()+"'", "where Id_proveedor='"+jTRUC+"'");
                this.dispose();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                jDModProveedor dialog = new jDModProveedor(new javax.swing.JFrame(), true,"","",0,"");
